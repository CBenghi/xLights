...
class RainbowPanel: public xlEffectPanel
{
	public:

		RainbowPanel(wxWindow* parent);
		virtual ~RainbowPanel();
		virtual void ValidateWindow() override;
		void SetTimingTracks(wxCommandEvent& event);

		//(*Declarations(RainbowPanel)
		...
		BulkEditChoice* Choice_Rainbow_MIDITrack_APPLYLAST;
		BulkEditChoice* Choice_Rainbow_Type;
	...
	protected:
		...
		//(*Identifiers(RainbowPanel)
		static const long ID_STATICTEXT_Rainbow_Type;
		static const long ID_CHOICE_Rainbow_Type;
		static const long ID_STATICTEXT_Rainbow_MIDITrack_APPLYLAST;
		static const long ID_CHOICE_Rainbow_MIDITrack_APPLYLAST;
